...
final class SqliteEnumTests: XCTestCase {
    ...
    func testErrorCode() {
        ...
        XCTAssertEqual(Sqlite.ErrorCode.OK.rawValue, SQLITE_OK)
        XCTAssertEqual(Sqlite.ErrorCode.ERROR.rawValue, SQLITE_ERROR)
        XCTAssertEqual(Sqlite.ErrorCode.INTERNAL.rawValue, SQLITE_INTERNAL)
        XCTAssertEqual(Sqlite.ErrorCode.PERM.rawValue, SQLITE_PERM)
        XCTAssertEqual(Sqlite.ErrorCode.ABORT.rawValue, SQLITE_ABORT)
        XCTAssertEqual(Sqlite.ErrorCode.BUSY.rawValue, SQLITE_BUSY)
        XCTAssertEqual(Sqlite.ErrorCode.LOCKED.rawValue, SQLITE_LOCKED)
        XCTAssertEqual(Sqlite.ErrorCode.NOMEM.rawValue, SQLITE_NOMEM)
        XCTAssertEqual(Sqlite.ErrorCode.READONLY.rawValue, SQLITE_READONLY)
        XCTAssertEqual(Sqlite.ErrorCode.INTERRUPT.rawValue, SQLITE_INTERRUPT)
        XCTAssertEqual(Sqlite.ErrorCode.IOERR.rawValue, SQLITE_IOERR)
        XCTAssertEqual(Sqlite.ErrorCode.CORRUPT.rawValue, SQLITE_CORRUPT)
        XCTAssertEqual(Sqlite.ErrorCode.NOTFOUND.rawValue, SQLITE_NOTFOUND)
        XCTAssertEqual(Sqlite.ErrorCode.FULL.rawValue, SQLITE_FULL)
        XCTAssertEqual(Sqlite.ErrorCode.CANTOPEN.rawValue, SQLITE_CANTOPEN)
        XCTAssertEqual(Sqlite.ErrorCode.PROTOCOL.rawValue, SQLITE_PROTOCOL)
        XCTAssertEqual(Sqlite.ErrorCode.EMPTY.rawValue, SQLITE_EMPTY)
        XCTAssertEqual(Sqlite.ErrorCode.SCHEMA.rawValue, SQLITE_SCHEMA)
        XCTAssertEqual(Sqlite.ErrorCode.TOOBIG.rawValue, SQLITE_TOOBIG)
        XCTAssertEqual(Sqlite.ErrorCode.CONSTRAINT.rawValue, SQLITE_CONSTRAINT)
        XCTAssertEqual(Sqlite.ErrorCode.MISMATCH.rawValue, SQLITE_MISMATCH)
        XCTAssertEqual(Sqlite.ErrorCode.MISUSE.rawValue, SQLITE_MISUSE)
        XCTAssertEqual(Sqlite.ErrorCode.NOLFS.rawValue, SQLITE_NOLFS)
        XCTAssertEqual(Sqlite.ErrorCode.AUTH.rawValue, SQLITE_AUTH)
        XCTAssertEqual(Sqlite.ErrorCode.FORMAT.rawValue, SQLITE_FORMAT)
        XCTAssertEqual(Sqlite.ErrorCode.RANGE.rawValue, SQLITE_RANGE)
        XCTAssertEqual(Sqlite.ErrorCode.NOTADB.rawValue, SQLITE_NOTADB)
        XCTAssertEqual(Sqlite.ErrorCode.NOTICE.rawValue, SQLITE_NOTICE)
        XCTAssertEqual(Sqlite.ErrorCode.WARNING.rawValue, SQLITE_WARNING)
        XCTAssertEqual(Sqlite.ErrorCode.ROW.rawValue, SQLITE_ROW)
        XCTAssertEqual(Sqlite.ErrorCode.DONE.rawValue, SQLITE_DONE)
